...
func init() {
	c.Destinations.Register("amplitude", c.ConfigMeta{
		...
		Properties: []c.ConfigProperty{
			...
			c.ArrayWithObject("traitsToIncrement", "traits", "traits_to_increment"),
			c.ArrayWithObject("traitsToSetOnce", "traits", "traits_to_set_once"),
			c.ArrayWithObject("traitsToAppend", "traits", "traits_to_append"),
			c.ArrayWithObject("traitsToPrepend", "traits", "traits_to_prepend"),
