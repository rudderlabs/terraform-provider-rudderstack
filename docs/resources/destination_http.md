...
This resource represents an HTTP Webhook destination. For more information check
...
- `api_key_name` (String) Enter the header name for API key authentication.
- `api_key_value` (String, Sensitive) Enter the value for API key authentication.
- `auth` (String) Select the authentication method used for the HTTP request.
- `bearer_token` (String, Sensitive) Enter the bearer token used for authorization.
...
- `password` (String, Sensitive) Enter the password for basic authentication.
...
- `username` (String) Enter the username for basic authentication.
