---
page_title: "rudderstack_destination_attentive_tag Resource - terraform-provider-rudderstack"
subcategory: ""
description: |-
  
---

# rudderstack_destination_attentive_tag (Resource)

This resource represents an Attentive Tag destination. For more information check 
https://www.rudderstack.com/docs/destinations/streaming-destinations/attentive-tag/
...
- `api_key` (String, Sensitive) Enter your API Key.
