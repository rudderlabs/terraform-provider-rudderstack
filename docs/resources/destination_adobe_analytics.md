...
- `event_merch_event_to_adobe_event` (List of Object) You can map Rudder Events to Adobe Event Merchandise events. (see [below for nested schema](#nestedatt--config--event_merch_event_to_adobe_event))
...
- `product_merch_event_to_adobe_event` (List of Object) You can map Rudder Events to Adobe Product Merchandise events (see [below for nested schema](#nestedatt--config--product_merch_event_to_adobe_event))
